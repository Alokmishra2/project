<%-- 
    Document   : loginjsp
    Created on : 28 Dec, 2021, 3:31:55 PM
    Author     : LENOVO
--%>
...
PreparedStatement stmt= con.prepareStatement("select password from data1 where username=?");
stmt.setString(1,uname); 
ResultSet rs= stmt.executeQuery(); 
if(rs.next()){     if(pass.equals(rs.getString(1)))
    { 
